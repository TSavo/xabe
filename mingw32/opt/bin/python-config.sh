...
prefix_build="/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt"
...
CFLAGS=$(echo "-O2 -pipe -I/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/include -I/c/mingw492/prerequisites/i686-zlib-static/include -I/c/mingw492/prerequisites/i686-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
