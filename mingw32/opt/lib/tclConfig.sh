...
# installed.
TCL_PREFIX='/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/build/tcl8.6.1/win -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/include'
...
TCL_PACKAGE_PATH='/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/build/tcl8.6.1/win -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/build/tcl8.6.1/win/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/c/mingw492/i686-492-posix-dwarf-rt_v3-rev0/mingw32/opt/lib/libtclstub86.a'
